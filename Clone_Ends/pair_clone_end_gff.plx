...
foreach my $lib (keys %hits){
    ...
    foreach my $clone (keys %{$hits{$lib}}){
        ...
        ## NOTE: if the best hits for each end don't form a 'good
        ## pair', we give up on the clone. About 3% of the clones
        ## could be 'recovered' by hunting for a lower scoring 'good
        ## pair', however, their quality is dubious, and they are
        ## complex to handle! We skip them here.
